...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    // Don't show the component at all if there are no related doctors
    if (relDoc.length === 0) {
        return null;
    }
    ...
    return (
        ...
        <div className='my-16 sm:my-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='flex flex-col items-center gap-3 text-center'>
                <h1 className='text-3xl font-bold text-gray-900'>Related Doctors</h1>
            ...
            {/* --- Responsive Grid ---
                - Replaced 'grid-cols-auto' with a proper responsive grid.
                - It's 1 column on mobile, 2 on small tablets, 3 on large tablets, and 4 on desktops.
                - Added a consistent 'gap-6'.
            */}
